...
function ProviderAuth() {
  ...
  const role = "provider"; // Hardcoded as provider
    ...
    <div style={{ backgroundColor: "#f0f2f5", minHeight: "100vh", paddingTop: "70px" }}>
      ...
      <div style={{ display: "flex", justifyContent: "center", alignItems: "center", minHeight: "calc(90vh - 70px)", padding: "20px" }}>
        <div style={{
          ...
          <h1 style={{ color: "#2ecc71", textAlign: "center" }}>ScholarSync</h1>
          ...
          <div className="toggle-container">
            ...
            <div className="toggle-slider" style={{ left: isSignUp ? "0%" : "50%", background: "linear-gradient(135deg, #2ecc71 0%, #27ae60 100%)" }}></div>
          </div>
          ...
          <div style={{ marginTop: "30px" }}>
            ...
            <button 
              ...
              style={{ 
                width: "100%", 
                padding: "12px", 
                backgroundColor: isSignUp ? "#2ecc71" : "#2ecc71", 
                color: "white", 
                border: "none", 
                borderRadius: "5px", 
                fontSize: "16px",
